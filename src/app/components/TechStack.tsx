    ...
    <>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 px-2">
        <div className="border-2 p-3 rounded-2xl flex flex-col justify-center items-center bg-neutral-700">
          <div className="text-2xl p-4 font-bold ">Languages</div>
        ...
        <div className="border-2 p-3 rounded-2xl flex flex-col justify-center items-center bg-neutral-700">
          <div className="text-2xl p-4 font-bold">Styling</div>
        ...
        <div className="border-2 p-3 rounded-2xl flex flex-col justify-center items-center bg-neutral-700">
          <div className="text-2xl p-4 font-bold">Frontend</div>
        ...
        <div className="border-2 rounded-2xl flex flex-col sm:grid-row-2 justify-center items-center bg-neutral-700">
          <div className="text-2xl p-4 font-bold ">Backend</div>
        ...
        <div className="border-2 p-3 rounded-2xl flex flex-col justify-center items-center bg-neutral-700">
          <div className="text-2xl p-4 font-bold">Testing</div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
